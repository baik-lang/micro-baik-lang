...
/* Other Data Word                                      */
  TYPE_NUM,           /* 223 number                     */
  TYPE_IDENT,         /* 224 variable or label name     */
  TYPE_STR,           /* 225 string                     */
  TYPE_DBL,           /* 226 double number              */
  TYPE_SYM,           /* 227 symbol char                */
  TYPE_ARRAY,         /* 228 array var                  */
  TYPE_OBJECT,        /* 229 object var                 */
  TYPE_OBJECT_FUNC,   /* 230 object func                */
